...
import com.bilgeadam.recepergan.clientcontroller.ControllerClientSearchDatabase;
import com.bilgeadam.recepergan.clientdao.DaoClientWriteToDatabase;
import com.bilgeadam.recepergan.clientdto.ArthistTsvDetail;
import com.bilgeadam.recepergan.clientdto.MoviesCsvDto;
import com.bilgeadam.recepergan.clientdto.MoviesTsvDetail;
import com.bilgeadam.recepergan.server.ClientTsv;
		...
		while (!choose.equals("0")) {
			...
			switch (choose) {
				case "1":
					...
					List<MoviesCsvDto> temp1 = ControllerClientSearchDatabase.getInstance()
				...
				case "2":
					...
					choose = scanner.next();
					List<MoviesCsvDto> temp2 = ControllerClientSearchDatabase.getInstance()
				...
				case "3":
					...
					choose = scanner.next();
					List<MoviesCsvDto> temp3 = ControllerClientSearchDatabase.getInstance()
				...
				case "4":
					...
					ArthistTsvDetail temp = (ArthistTsvDetail) client.run(choose + "&artist");
